...
import { AddCustomer, Signupuser, UserForOtp } from '../signupuser/signupuser';


@Component({
  selector: 'app-signupmerchantuser',
  templateUrl: './signupmerchantuser.component.html',
  styleUrls: ['./signupmerchantuser.component.scss']
})
export class SignupmerchantuserComponent {
    ...
    tokenVisible: boolean = false;
      ...
      constructor(public formBuilder: FormBuilder,public appService: AppService,
        ...
        private router: Router,private EncrDecr: EncrDecrServiceService)
       {
        ...
        let SplitCode = dryptedmerchantcode.split("M00");
